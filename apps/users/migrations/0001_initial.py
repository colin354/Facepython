# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-09-26 16:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('streamurl', models.URLField(null=True, verbose_name='视频地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('person_id', models.CharField(max_length=10, verbose_name='人员ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reid_imgurl', models.CharField(max_length=100, verbose_name='top图片地址')),
                ('personreid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.PersonReid')),
            ],
            options={
                'verbose_name': '行人重识别TOP5图片',
                'verbose_name_plural': '行人重识别TOP5图片',
            },
        ),
        migrations.CreateModel(
            name='Stranger',
