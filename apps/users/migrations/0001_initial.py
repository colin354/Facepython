# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-07-03 19:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.IntegerField(null=True, verbose_name='时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.IntegerField(choices=[(0, 'new'), (1, 'update'), (2, 'delete')], default=0)),
                ('createDate', models.DateTimeField(auto_now_add=True)),
                ('streamtime', models.CharField(blank=True, max_length=24, verbose_name='时长')),
                ('streamfps', models.CharField(blank=True, max_length=24, verbose_name='帧率')),
                ('streamstatus', models.IntegerField(choices=[(0, 'unhandle'), (1, 'inhandle'), (2, 'handleok'), (3, 'handlefalse')], default=0, verbose_name='检测状态')),
            ],
            options={
